...
// Apply rate limits: strict on auth endpoints
app.use('/api/auth/login', rateLimit(10, 60000));
...
app.use((err, req, res, next) => {
  log('error', 'unhandled_error', { error: err.message, traceId: req.traceId });
